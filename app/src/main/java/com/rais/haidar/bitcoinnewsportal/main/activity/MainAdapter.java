package com.rais.haidar.bitcoinnewsportal.main.activity;
...
import com.rais.haidar.bitcoinnewsportal.R;
...
class MainAdapter extends RecyclerView.Adapter<MainAdapter.MainViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull MainAdapter.MainViewHolder mainViewHolder, final int i) {
    ...
    public class
    MainViewHolder extends RecyclerView.ViewHolder {
